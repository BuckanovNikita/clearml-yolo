...
около 12 с компиляции на процесс против ~5% выигрыша в установившемся режиме — сплит из
748 изображений заканчивается раньше, чем это окупается. В конвейере компиляция при этом
оплачивается один раз: этап предсказаний и обе стороны сравнения идут в одном процессе.
